    ...
    return (
        <div id='login_page' className='d-flex'>
            ...
            <section className='w-50 d-flex flex-column align-items-center justify-content-center'>
                <h1 className='fw-bold text-danger-emphasis mb-5'>Đăng ký học tập</h1>
                <div className='d-flex flex-column align-items-center gap-3'>
                    <h3 className='fw-semibold text-secondary-emphasis mb-3'>Đăng nhập</h3>
                    
                    <div>
                        <label className='form-label fw-semibold'>Vai trò</label>
                        <div className='d-flex align-items-center gap-2'>
                            {/* <span className='fw-semibold me-2'>Bạn là: </span> */}
                            {roles.map(({ role: userRole, label }, index) => (<span key={index}>
                                <input
                                    type="radio" 
                                    className="btn-check"
                                    name="role" 
                                ...
                                />
                                <label 
                                    className={`btn ${role === userRole ? 'fw-semibold' : 'text-secondary'}`}
                                    htmlFor={userRole}
